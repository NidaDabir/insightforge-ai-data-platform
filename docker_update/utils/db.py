...
# Allow overriding via env var (used in Docker to point at a mounted volume)
# Falls back to project root for local/Windows runs.
DB_PATH = os.environ.get(
    "DATABASE_PATH",
    os.path.join(os.path.dirname(__file__), "..", "insightforge.db")
)
